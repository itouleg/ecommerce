...
function GetLangOpts($llcc, $adobeCJK) {
	...
	//	else { $unifonts = ""; }
	  ...
	  //CASE "th":  $unifonts = "garuda,garudaB,garudaI,garudaBI,norasi,norasiB,norasiI,norasiBI";  break;
          CASE "th":  $unifonts = "garuda, garudaB, garudaI, garudaBI, norasi, norasiB, norasiI, norasiBI, THSaraban,THSarabanI, THSarabanB, THSarabanBI,Cordia,CordiaI,CordiaB,CordiaBI,Tahoma,TahomaI,TahomaB,TahomaBI";  break;
	  // VIETNAMESE
	  CASE "vi":  
