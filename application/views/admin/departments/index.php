                    ...
                    $gridview->render(array(
                        ...
                        "columns" => array(
                            ...
                            "dep_status" => array(
                                ...
                                "class" => "label",
                                "status" => array(
                                    '<span class="label center change-status cursor" value="0" id="{dep_id}">Inactive</span>',
                                    '<span class="label label-success center change-status cursor" value="1" id="{dep_id}">Active</span>',
                        ...
                        "actions" => array(
                            ...
                            "view" => array(
                                "url" => "departments/view/{dep_id}"
                            ),
                            "edit" => array(
                                "url" => "departments/edit/{dep_id}"
                            ),
                            "delete" => array(
                                "url" => "departments/delete/{dep_id}"
                            )
                        )
                    ));
                    ?>
