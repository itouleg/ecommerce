                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span><strong>Create Menu</strong></h2>
                                <div class="box-icon">
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="menu_title" id="menu_title" type="text" required>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                                <label class="control-label">Title (EN)</label>
                                                <div class="controls">
                                                    <input name="menu_title_en" id="menu_title_en" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="control-group span6 selecttype hidden">
                                                <label class="control-label">Select</label>
                                                <div class="controls">
                                                    <select name="menu_params" id="menu_params"></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="menu_link" id="menu_link" type="text">
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                                <label class="control-label">Link Method</label>
                                                <div class="controls">
                                                    <select name="menu_linktype" id="menu_linktype">
                                                        <option value=""></option>
