                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span><strong>Create Page</strong></h2>
                                <div class="box-icon">
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="control-group span12">
                                                ...
                                                <div class="controls">
                                                    <input name="page_title" id="page_title" type="text"  style="width:90%;" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <textarea name="page_tag" id="page_tag" style="width:100%;"></textarea>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
