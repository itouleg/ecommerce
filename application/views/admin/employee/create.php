                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span><strong>Create Employee</strong></h2>
                                <div class="box-icon">
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="user_fullname" id="user_fullname" type="text" required>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                        ...
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="user_username" id="user_username" type="text" required>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="user_mobile" id="user_mobile" type="tel">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
