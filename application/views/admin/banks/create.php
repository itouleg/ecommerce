                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="bank_name" id="bank_name" type="text" required>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                                <label class="control-label">Branch</label>
                                                <div class="controls">
                                                    <input name="bank_branch" id="bank_branch" type="text" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="bank_holder" id="bank_holder" type="text" required>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                                <label class="control-label">Account No</label>
                                                <div class="controls">
                                                    <input name="bank_accountno" id="bank_accountno" type="text" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
