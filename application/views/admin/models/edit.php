                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span><strong>Edit Model</strong></h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                ...
                                <form class="form-horizontal" name="form1" id="form1" method="post" action="<?=site_url("admin/models/edit/".$model['model_id']);?>">
                                    <input name="model_id" id="model_id" type="hidden" value="<?=$model['model_id'];?>">
                                    <fieldset>
                                        <div class="row">
                                            <div class="control-group span6">
                                                <label class="control-label">Model Name</label>
                                                <div class="controls">
                                                    <input name="model_name" id="model_name" type="text" value="<?=$model['model_name'];?>" required>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <select name="model_brand" id="model_brand" required>
                                                        ...
                                                        {
                                                            if($model['model_brand']==$ban['brand_id'])
                                                            {
                                                                echo '<option value="'.$ban['brand_id'].'" selected>'.$ban['brand_name'].'</option>';
                                                            }else{
                                            ...
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <select name="model_status" id="model_status">
                                                        <option value="1" <?=$model['model_status']==1?"selected":"";?> >Active</option>
                                                        <option value="0" <?=$model['model_status']==0?"selected":"";?> >Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
