                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="control-group span6">
                                                ...
                                                <div class="controls">
                                                    <input name="currency_buy" id="currency_buy" type="text" placeholder="0.00" required>
                                                </div>
                                            </div>
                                            <div class="control-group span6">
                                                <label class="control-label">Sell</label>
                                                <div class="controls">
                                                    <input name="currency_sell" id="currency_sell" type="text" placeholder="0.00" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
